...
export default function UserDashboardPage() {
  ...
  const { user: authUser, loading: authLoading } = useAuth(['STUDENT', 'PERSONAL'])
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const response = await fetch(`/api/community/${communitySlug}/user/dashboard`, {
        headers: {
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              <div className="flex items-center justify-between mb-6">
                ...
                <Link href={`/community/${communitySlug}/user/submissions`} className="text-blue-600 hover:text-blue-700 text-sm font-medium">
                  View all
                </Link>
              </div>
          ...
          <div>
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200 mb-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <Link href={`/community/${communitySlug}/user/contests`} className="text-blue-600 hover:text-blue-700 text-sm font-medium">
                  View all
                </Link>
              </div>
              <div className="space-y-4">
